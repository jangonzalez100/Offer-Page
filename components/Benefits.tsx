  ...
  return (
    <section id="maintenance" className="py-24 px-6 lg:px-12 bg-black relative overflow-hidden border-b border-white/10">
      ...
      <div className="max-w-[1440px] mx-auto relative z-10">
        <div className="mb-20">
          <h2 className="font-display text-4xl md:text-7xl mb-6 tracking-tighter leading-none uppercase">
            THE <span className="text-studio-gold">$50 MONTHLY</span><br />CLEAR CHOICE.
          </h2>
          <div className="w-20 h-1 bg-studio-gold mb-8"></div>
          <p className="text-white/40 text-lg md:text-2xl font-bold max-w-2xl leading-tight tracking-tighter uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border border-white/10">
          {BENEFITS.map((benefit) => (
            <div 
              key={benefit.id} 
              className="p-8 border border-white/10 hover:border-studio-gold/30 transition-all duration-300 group bg-white/[0.01] flex flex-col min-h-[300px]"
            >
              <div className="flex-grow">
                ...
                <p className="text-white/40 leading-relaxed text-[13px] font-medium tracking-tight uppercase">
                  {benefit.description}
                </p>
              </div>
